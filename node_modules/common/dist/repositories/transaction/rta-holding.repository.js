...
exports.RtaHoldingRepository = void 0;
const tslib_1 = require("tslib");
const repositories_1 = require("../../repositories");
const repository_1 = require("@loopback/repository");
const models_1 = require("../../models");
let RtaHoldingRepository = class RtaHoldingRepository extends repositories_1.BaseLocalRepository {
    constructor(dataSource, rtaRepositoryGetter, uploadedByAppUserRepositoryGetter, transactionAppFileRepositoryGetter, rtaHoldingReconciliationRepositoryGetter) {
        super(models_1.RtaHolding, dataSource);
        ...
        this.rtaHoldingReconciliations = this.createHasManyRepositoryFactoryFor('rtaHoldingReconciliations', rtaHoldingReconciliationRepositoryGetter);
...
RtaHoldingRepository = (0, tslib_1.__decorate)([
    ...
    (0, tslib_1.__param)(4, repository_1.repository.getter('RtaHoldingReconciliationRepository')),
    (0, tslib_1.__metadata)("design:paramtypes", [repository_1.juggler.DataSource, Function, Function, Function, Function])
], RtaHoldingRepository);
exports.RtaHoldingRepository = RtaHoldingRepository;
//# sourceMappingURL=rta-holding.repository.js.map