...
Option.GLOBALOPTIONS = {
    ...
    APPUSERSTATUS: {
        ...
        bankAccountIsReady: {
            ...
            currentState: ['PINSetupCompleted', 'IDCOMVerified']
        },
        FATCAReady: {
            value: 10,
            label: 'FATCA Setup',
    ...
    KYCSTATUS: {
        ...
        hold: {
            value: 6,
            label: 'MF KYC On Hold',
            sequence: 6
        },
        incomplete: {
            value: 7,
            label: 'MF KYC Incomplete',
            sequence: 7
        }
    },
    ...
    DEPOSITDETAILSACTIONONMATURITY: {
        ...
        maturityProceedsToFDPI: {
            value: 2,
            label: 'Convert to Fixed Deposit (Principal and Interest)',
            sequence: 6
        },
        maturityProceedsToFDP: {
            value: 3,
            label: 'Convert to Fixed Deposit (Principal Only)',
            sequence: 7
        }
    },
    ...
    REBALANCINGSETTINGS: {
        alertForUrgent: true,
        goalShortfallTolerance: 0.1,
        assetClassDeviationTolerance: 0.05,
        categoryGroupDeviationTolerance: 0.05,
        goalShortfallToleranceUrgent: 0.2,
        assetClassDeviationToleranceUrgent: 0.1,
        categoryGroupDeviationToleranceUrgent: 0.1,
        precisionPoint: 0.00001,
        percentCentBase: 1,
        cleanUpNotRecommendedSchemes: true,
    ...
    WMSGENERICMESSAGES: {
        technicalError: {
            ...
            message: 'Oops! You have experienced a Technical Error(CUST_ERR_CODE)'
        },
        customerError: {
            value: 2,
