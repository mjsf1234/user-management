...
async function pseudonymisation() {
    ...
    const addressRepository = await app.getRepository(common_1.AddressRepository);
    let batchSize = 1000;
    ...
    async function processBatch(batchObject) {
        ...
        const keysToEncode = [
            { addressLine1: common_1.Address.definition.properties.addressLine1 },
            { addressLine2: common_1.Address.definition.properties.addressLine2 },
            { addressLine3: common_1.Address.definition.properties.addressLine3 },
            { fullAddress: common_1.Address.definition.properties.fullAddress }
        ];
        const encodedData = common_1.CryptoUtils.encodeDataObjectPseudonym(addressIdArray, keysToEncode);
...
//# sourceMappingURL=004-pseudonymise-address.js.map