    ...
    common_1.QueueUtils.listQueues()
        ...
        underscore_1.default.each(Object.keys(queue_configuration_1.default.queues), function (key) {
            if (existingQueues.indexOf(queue_configuration_1.default.queues[key].queueName) == -1) {
                ...
                common_1.LoggingUtils.info('deleting queue ' + queue_configuration_1.default.queues[key].queueName);
                promises.push(common_1.QueueUtils.deleteQueues(queue_configuration_1.default.queues[key].queueName));
            }
        });
...
//# sourceMappingURL=delete-queues.js.map